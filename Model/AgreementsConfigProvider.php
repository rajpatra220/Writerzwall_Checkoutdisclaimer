 ...
 * Checkout Disclaimer
 *
 * @package Writerzwall_Checkoutdisclaimer
 * @author Rajesh Patra <rajpatra220@gmail.com>
 * @copyright 2020-2030 Writerzwall
 * @license OSL-3.0, AFL-3.0
 */
namespace Writerzwall\Checkoutdisclaimer\Model;
...
{
    const DISCLAIMERCONTENT = 'checkoutdisclaimer/general/disclaimercontent';
    ...
    protected function getAgreementsConfig()
    {
        ...
        $agreementConfiguration['disclaimerContent'] = $this->getDisclaimerContent();
    ...
    {
        return $this->scopeConfiguration->getValue(self::DISCLAIMERCONTENT,
            ScopeInterface::SCOPE_STORE);
    }
